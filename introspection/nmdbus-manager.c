...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_get_devices_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_get_devices_OUT_ARG_devices,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_get_devices_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_get_devices",
  NULL
};

static const GDBusAnnotationInfo * const _nmdbus_manager_method_get_devices_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_get_devices_annotation_info_0,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_get_devices_annotation_info_pointers
  },
  "handle-get-devices",
  FALSE
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_get_device_by_ip_iface_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_get_device_by_ip_iface_IN_ARG_iface,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_get_device_by_ip_iface_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_get_device_by_ip_iface_OUT_ARG_device,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_get_device_by_ip_iface_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_get_device_by_ip_iface",
  NULL
};

static const GDBusAnnotationInfo * const _nmdbus_manager_method_get_device_by_ip_iface_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_get_device_by_ip_iface_annotation_info_0,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_get_device_by_ip_iface_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_activate_connection_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_activate_connection_IN_ARG_connection,
  &_nmdbus_manager_method_info_activate_connection_IN_ARG_device,
  &_nmdbus_manager_method_info_activate_connection_IN_ARG_specific_object,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_activate_connection_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_activate_connection_OUT_ARG_active_connection,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_activate_connection_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_activate_connection",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_activate_connection_annotation_info_1 =
{
  -1,
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_activate_connection_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_activate_connection_annotation_info_0,
  &_nmdbus_manager_method_activate_connection_annotation_info_1,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_activate_connection_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_add_and_activate_connection_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_add_and_activate_connection_IN_ARG_connection,
  &_nmdbus_manager_method_info_add_and_activate_connection_IN_ARG_device,
  &_nmdbus_manager_method_info_add_and_activate_connection_IN_ARG_specific_object,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_add_and_activate_connection_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_add_and_activate_connection_OUT_ARG_path,
  &_nmdbus_manager_method_info_add_and_activate_connection_OUT_ARG_active_connection,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_add_and_activate_connection_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_add_and_activate_connection",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_add_and_activate_connection_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_add_and_activate_connection_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_add_and_activate_connection_annotation_info_0,
  &_nmdbus_manager_method_add_and_activate_connection_annotation_info_1,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_add_and_activate_connection_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_deactivate_connection_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_deactivate_connection_IN_ARG_active_connection,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_deactivate_connection_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_deactivate_connection",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_deactivate_connection_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_deactivate_connection_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_deactivate_connection_annotation_info_0,
  &_nmdbus_manager_method_deactivate_connection_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_deactivate_connection_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_sleep_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_sleep_IN_ARG_sleep,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_sleep_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_sleep",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_sleep_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_sleep_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_sleep_annotation_info_0,
  &_nmdbus_manager_method_sleep_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_sleep_annotation_info_pointers
  },
  "handle-sleep",
  FALSE
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_enable_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_enable_IN_ARG_enable,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_enable_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_enable",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_enable_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_enable_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_enable_annotation_info_0,
  &_nmdbus_manager_method_enable_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_enable_annotation_info_pointers
  },
  "handle-enable",
  FALSE
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_get_permissions_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_get_permissions_OUT_ARG_permissions,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_get_permissions_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_get_permissions",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_get_permissions_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_get_permissions_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_get_permissions_annotation_info_0,
  &_nmdbus_manager_method_get_permissions_annotation_info_1,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_get_permissions_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_set_logging_IN_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_set_logging_IN_ARG_level,
  &_nmdbus_manager_method_info_set_logging_IN_ARG_domains,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_set_logging_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_set_logging",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_set_logging_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_set_logging_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_set_logging_annotation_info_0,
  &_nmdbus_manager_method_set_logging_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_set_logging_annotation_info_pointers
  },
  "handle-set-logging",
  FALSE
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_get_logging_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_get_logging_OUT_ARG_level,
  &_nmdbus_manager_method_info_get_logging_OUT_ARG_domains,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_get_logging_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_get_logging",
  NULL
};

static const GDBusAnnotationInfo * const _nmdbus_manager_method_get_logging_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_get_logging_annotation_info_0,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_get_logging_annotation_info_pointers
  },
  "handle-get-logging",
  FALSE
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_check_connectivity_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_check_connectivity_OUT_ARG_connectivity,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_check_connectivity_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_check_connectivity",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_check_connectivity_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_manager_method_check_connectivity_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_check_connectivity_annotation_info_0,
  &_nmdbus_manager_method_check_connectivity_annotation_info_1,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_check_connectivity_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_method_info_state_OUT_ARG_pointers[] =
{
  &_nmdbus_manager_method_info_state_OUT_ARG_state,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_manager_method_state_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_manager_get_state",
  NULL
};

static const GDBusAnnotationInfo * const _nmdbus_manager_method_state_annotation_info_pointers[] =
{
  &_nmdbus_manager_method_state_annotation_info_0,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_manager_method_state_annotation_info_pointers
  },
  "handle-state",
  FALSE
};

static const _ExtendedGDBusMethodInfo * const _nmdbus_manager_method_info_pointers[] =
{
  &_nmdbus_manager_method_info_get_devices,
  &_nmdbus_manager_method_info_get_device_by_ip_iface,
  &_nmdbus_manager_method_info_activate_connection,
  &_nmdbus_manager_method_info_add_and_activate_connection,
  &_nmdbus_manager_method_info_deactivate_connection,
  &_nmdbus_manager_method_info_sleep,
  &_nmdbus_manager_method_info_enable,
  &_nmdbus_manager_method_info_get_permissions,
  &_nmdbus_manager_method_info_set_logging,
  &_nmdbus_manager_method_info_get_logging,
  &_nmdbus_manager_method_info_check_connectivity,
  &_nmdbus_manager_method_info_state,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_signal_info_state_changed_ARG_pointers[] =
{
  &_nmdbus_manager_signal_info_state_changed_ARG_state,
  NULL
};
...
static const _ExtendedGDBusArgInfo _nmdbus_manager_signal_info_properties_changed_ARG_properties =
{
  {
    -1,
    (gchar *) "properties",
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_signal_info_properties_changed_ARG_pointers[] =
{
  &_nmdbus_manager_signal_info_properties_changed_ARG_properties,
  NULL
};

static const _ExtendedGDBusSignalInfo _nmdbus_manager_signal_info_properties_changed =
{
  {
    -1,
    (gchar *) "PropertiesChanged",
    (GDBusArgInfo **) &_nmdbus_manager_signal_info_properties_changed_ARG_pointers,
    NULL
  },
  "properties-changed"
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_signal_info_device_added_ARG_pointers[] =
{
  &_nmdbus_manager_signal_info_device_added_ARG_device_path,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_manager_signal_info_device_removed_ARG_pointers[] =
{
  &_nmdbus_manager_signal_info_device_removed_ARG_device_path,
  NULL
};
...
static const _ExtendedGDBusSignalInfo * const _nmdbus_manager_signal_info_pointers[] =
{
  &_nmdbus_manager_signal_info_check_permissions,
  &_nmdbus_manager_signal_info_state_changed,
  &_nmdbus_manager_signal_info_properties_changed,
  &_nmdbus_manager_signal_info_device_added,
  &_nmdbus_manager_signal_info_device_removed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _nmdbus_manager_property_info_pointers[] =
{
  &_nmdbus_manager_property_info_devices,
  &_nmdbus_manager_property_info_networking_enabled,
  &_nmdbus_manager_property_info_wireless_enabled,
  &_nmdbus_manager_property_info_wireless_hardware_enabled,
  &_nmdbus_manager_property_info_wwan_enabled,
  &_nmdbus_manager_property_info_wwan_hardware_enabled,
  &_nmdbus_manager_property_info_wimax_enabled,
  &_nmdbus_manager_property_info_wimax_hardware_enabled,
  &_nmdbus_manager_property_info_active_connections,
  &_nmdbus_manager_property_info_primary_connection,
  &_nmdbus_manager_property_info_primary_connection_type,
  &_nmdbus_manager_property_info_metered,
  &_nmdbus_manager_property_info_activating_connection,
  &_nmdbus_manager_property_info_startup,
  &_nmdbus_manager_property_info_version,
  &_nmdbus_manager_property_info_state,
  &_nmdbus_manager_property_info_connectivity,
  NULL
};
 ...
 * @properties_changed: Handler for the #NMDBusManager::properties-changed signal.
...
nmdbus_manager_default_init (NMDBusManagerIface *iface)
{
  ...
  /**
   * NMDBusManager::properties-changed:
   * @object: A #NMDBusManager.
   * @arg_properties: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-org-freedesktop-NetworkManager.PropertiesChanged">"PropertiesChanged"</link> is received.
   *
   * On the service-side, this signal can be used with e.g. g_signal_emit_by_name() to make the object emit the D-Bus signal.
   */
  g_signal_new ("properties-changed",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (NMDBusManagerIface, properties_changed),
    NULL,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_NONE,
 ...
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_manager_dup_devices() if on another thread.</warning>
 *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_manager_dup_active_connections() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_manager_dup_primary_connection() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_manager_dup_primary_connection_type() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_manager_dup_activating_connection() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_manager_dup_version() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
...
/**
 * nmdbus_manager_emit_properties_changed:
 * @object: A #NMDBusManager.
 * @arg_properties: Argument to pass with the signal.
 *
 * Emits the <link linkend="gdbus-signal-org-freedesktop-NetworkManager.PropertiesChanged">"PropertiesChanged"</link> D-Bus signal.
 */
void
nmdbus_manager_emit_properties_changed (
    NMDBusManager *object,
 ...
 * @proxy: A #NMDBusManagerProxy.
 * @out_active_connection: (out): Return location for return parameter or %NULL to ignore.
 ...
 * @proxy: A #NMDBusManagerProxy.
 * @out_level: (out): Return location for return parameter or %NULL to ignore.
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _nmdbus_manager_property_info_pointers[prop_id - 1];
...
static void
_nmdbus_manager_on_signal_properties_changed (
    NMDBusManager *object,
    GVariant *arg_properties)
{
  NMDBusManagerSkeleton *skeleton = NMDBUS_MANAGER_SKELETON (object);
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      GDBusConnection *connection = l->data;
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "org.freedesktop.NetworkManager", "PropertiesChanged",
        signal_variant, NULL);
    }
  g_variant_unref (signal_variant);
  g_list_free_full (connections, g_object_unref);
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _nmdbus_manager_schedule_emit_changed (skeleton, _nmdbus_manager_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
...
nmdbus_manager_skeleton_iface_init (NMDBusManagerIface *iface)
{
  ...
  iface->properties_changed = _nmdbus_manager_on_signal_properties_changed;
