...
static const _ExtendedGDBusArgInfo _nmdbus_access_point_signal_info_properties_changed_ARG_properties =
{
  {
    -1,
    (gchar *) "properties",
...
static const _ExtendedGDBusArgInfo * const _nmdbus_access_point_signal_info_properties_changed_ARG_pointers[] =
{
  &_nmdbus_access_point_signal_info_properties_changed_ARG_properties,
  NULL
};

static const _ExtendedGDBusSignalInfo _nmdbus_access_point_signal_info_properties_changed =
{
  {
    -1,
    (gchar *) "PropertiesChanged",
    (GDBusArgInfo **) &_nmdbus_access_point_signal_info_properties_changed_ARG_pointers,
    NULL
  },
  "properties-changed"
};

static const _ExtendedGDBusSignalInfo * const _nmdbus_access_point_signal_info_pointers[] =
{
  &_nmdbus_access_point_signal_info_properties_changed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _nmdbus_access_point_property_info_pointers[] =
{
  &_nmdbus_access_point_property_info_flags,
  &_nmdbus_access_point_property_info_wpa_flags,
  &_nmdbus_access_point_property_info_rsn_flags,
  &_nmdbus_access_point_property_info_ssid,
  &_nmdbus_access_point_property_info_frequency,
  &_nmdbus_access_point_property_info_hw_address,
  &_nmdbus_access_point_property_info_mode,
  &_nmdbus_access_point_property_info_max_bitrate,
  &_nmdbus_access_point_property_info_strength,
  &_nmdbus_access_point_property_info_last_seen,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusSignalInfo **) &_nmdbus_access_point_signal_info_pointers,
 ...
 * @properties_changed: Handler for the #NMDBusAccessPoint::properties-changed signal.
 *
...
nmdbus_access_point_default_init (NMDBusAccessPointIface *iface)
{
  ...
  /**
   * NMDBusAccessPoint::properties-changed:
   * @object: A #NMDBusAccessPoint.
   * @arg_properties: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-org-freedesktop-NetworkManager-AccessPoint.PropertiesChanged">"PropertiesChanged"</link> is received.
   *
  ...
  g_signal_new ("properties-changed",
    ...
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (NMDBusAccessPointIface, properties_changed),
    NULL,
    NULL,
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_access_point_dup_ssid() if on another thread.</warning>
 *
 ...
 */
void
nmdbus_access_point_set_ssid (NMDBusAccessPoint *object, const gchar *value)
{
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_access_point_dup_hw_address() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
...
/**
 * nmdbus_access_point_emit_properties_changed:
 * @object: A #NMDBusAccessPoint.
 * @arg_properties: Argument to pass with the signal.
 *
 * Emits the <link linkend="gdbus-signal-org-freedesktop-NetworkManager-AccessPoint.PropertiesChanged">"PropertiesChanged"</link> D-Bus signal.
 */
void
nmdbus_access_point_emit_properties_changed (
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _nmdbus_access_point_property_info_pointers[prop_id - 1];
...
static void
_nmdbus_access_point_on_signal_properties_changed (
    NMDBusAccessPoint *object,
    GVariant *arg_properties)
{
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      ...
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "org.freedesktop.NetworkManager.AccessPoint", "PropertiesChanged",
        signal_variant, NULL);
    }
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _nmdbus_access_point_schedule_emit_changed (skeleton, _nmdbus_access_point_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
...
{
  iface->properties_changed = _nmdbus_access_point_on_signal_properties_changed;
