...
static const GDBusAnnotationInfo _nmdbus_device_method_disconnect_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_device_disconnect",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_device_method_disconnect_annotation_info_1 =
{
  -1,
...
static const GDBusAnnotationInfo * const _nmdbus_device_method_disconnect_annotation_info_pointers[] =
{
  &_nmdbus_device_method_disconnect_annotation_info_0,
  &_nmdbus_device_method_disconnect_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_device_method_disconnect_annotation_info_pointers
  },
  "handle-disconnect",
  FALSE
};

static const GDBusAnnotationInfo _nmdbus_device_method_delete_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_device_delete",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_device_method_delete_annotation_info_1 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.Async",
  (gchar *) "",
...
static const GDBusAnnotationInfo * const _nmdbus_device_method_delete_annotation_info_pointers[] =
{
  &_nmdbus_device_method_delete_annotation_info_0,
  &_nmdbus_device_method_delete_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_device_method_delete_annotation_info_pointers
  },
  "handle-delete",
  FALSE
};

static const _ExtendedGDBusMethodInfo * const _nmdbus_device_method_info_pointers[] =
{
  &_nmdbus_device_method_info_disconnect,
  &_nmdbus_device_method_info_delete,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_signal_info_state_changed_ARG_pointers[] =
{
  &_nmdbus_device_signal_info_state_changed_ARG_new_state,
  &_nmdbus_device_signal_info_state_changed_ARG_old_state,
  &_nmdbus_device_signal_info_state_changed_ARG_reason,
  NULL
};
...
static const _ExtendedGDBusSignalInfo * const _nmdbus_device_signal_info_pointers[] =
{
  &_nmdbus_device_signal_info_state_changed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _nmdbus_device_property_info_pointers[] =
{
  &_nmdbus_device_property_info_udi,
  &_nmdbus_device_property_info_interface,
  &_nmdbus_device_property_info_ip_interface,
  &_nmdbus_device_property_info_driver,
  &_nmdbus_device_property_info_driver_version,
  &_nmdbus_device_property_info_firmware_version,
  &_nmdbus_device_property_info_capabilities,
  &_nmdbus_device_property_info_ip4_address,
  &_nmdbus_device_property_info_state,
  &_nmdbus_device_property_info_state_reason,
  &_nmdbus_device_property_info_active_connection,
  &_nmdbus_device_property_info_ip4_config,
  &_nmdbus_device_property_info_dhcp4_config,
  &_nmdbus_device_property_info_ip6_config,
  &_nmdbus_device_property_info_dhcp6_config,
  &_nmdbus_device_property_info_managed,
  &_nmdbus_device_property_info_autoconnect,
  &_nmdbus_device_property_info_firmware_missing,
  &_nmdbus_device_property_info_device_type,
  &_nmdbus_device_property_info_available_connections,
  &_nmdbus_device_property_info_physical_port_id,
  &_nmdbus_device_property_info_mtu,
  &_nmdbus_device_property_info_metered,
  NULL
};
 ...
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_udi() if on another thread.</warning>
 *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_interface() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_ip_interface() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_driver() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_driver_version() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_firmware_version() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_state_reason() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
GVariant *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_active_connection() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_ip4_config() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_dhcp4_config() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_ip6_config() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_dhcp6_config() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_available_connections() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_dup_physical_port_id() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _nmdbus_device_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _nmdbus_device_schedule_emit_changed (skeleton, _nmdbus_device_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
...
nmdbus_device_skeleton_get_mtu (NMDBusDevice *object)
{
  ...
  guint value;
  g_mutex_lock (&skeleton->priv->lock);
  value = g_value_get_uint (&(skeleton->priv->properties[21]));
  g_mutex_unlock (&skeleton->priv->lock);
  return value;
}
