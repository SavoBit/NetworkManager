...
#ifndef __NMDBUS_DEVICE_OLPC_MESH_H__
#define __NMDBUS_DEVICE_OLPC_MESH_H__
...
void nmdbus_device_olpc_mesh_emit_properties_changed (
    NMDBusDeviceOlpcMesh *object,
    GVariant *arg_properties);
...
#endif /* __NMDBUS_DEVICE_OLPC_MESH_H__ */
