...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_wifi_method_info_get_access_points_OUT_ARG_pointers[] =
{
  &_nmdbus_device_wifi_method_info_get_access_points_OUT_ARG_access_points,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_device_wifi_method_get_access_points_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_device_get_access_points",
  NULL
};

static const GDBusAnnotationInfo * const _nmdbus_device_wifi_method_get_access_points_annotation_info_pointers[] =
{
  &_nmdbus_device_wifi_method_get_access_points_annotation_info_0,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_device_wifi_method_get_access_points_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_wifi_method_info_get_all_access_points_OUT_ARG_pointers[] =
{
  &_nmdbus_device_wifi_method_info_get_all_access_points_OUT_ARG_access_points,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_device_wifi_method_get_all_access_points_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_device_get_all_access_points",
  NULL
};

static const GDBusAnnotationInfo * const _nmdbus_device_wifi_method_get_all_access_points_annotation_info_pointers[] =
{
  &_nmdbus_device_wifi_method_get_all_access_points_annotation_info_0,
  NULL
};
...
{
  {
    ...
    (GDBusAnnotationInfo **) &_nmdbus_device_wifi_method_get_all_access_points_annotation_info_pointers
  },
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_wifi_method_info_request_scan_IN_ARG_pointers[] =
{
  &_nmdbus_device_wifi_method_info_request_scan_IN_ARG_options,
  NULL
};

static const GDBusAnnotationInfo _nmdbus_device_wifi_method_request_scan_annotation_info_0 =
{
  -1,
  (gchar *) "org.freedesktop.DBus.GLib.CSymbol",
  (gchar *) "impl_device_request_scan",
  NULL
};

static const GDBusAnnotationInfo _nmdbus_device_wifi_method_request_scan_annotation_info_1 =
{
  -1,
...
static const GDBusAnnotationInfo * const _nmdbus_device_wifi_method_request_scan_annotation_info_pointers[] =
{
  &_nmdbus_device_wifi_method_request_scan_annotation_info_0,
  &_nmdbus_device_wifi_method_request_scan_annotation_info_1,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusAnnotationInfo **) &_nmdbus_device_wifi_method_request_scan_annotation_info_pointers
  },
  "handle-request-scan",
  FALSE
};

static const _ExtendedGDBusMethodInfo * const _nmdbus_device_wifi_method_info_pointers[] =
{
  &_nmdbus_device_wifi_method_info_get_access_points,
  &_nmdbus_device_wifi_method_info_get_all_access_points,
  &_nmdbus_device_wifi_method_info_request_scan,
  NULL
};

static const _ExtendedGDBusArgInfo _nmdbus_device_wifi_signal_info_properties_changed_ARG_properties =
{
  {
    -1,
    (gchar *) "properties",
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_wifi_signal_info_properties_changed_ARG_pointers[] =
{
  &_nmdbus_device_wifi_signal_info_properties_changed_ARG_properties,
  NULL
};

static const _ExtendedGDBusSignalInfo _nmdbus_device_wifi_signal_info_properties_changed =
{
  {
    -1,
    (gchar *) "PropertiesChanged",
    (GDBusArgInfo **) &_nmdbus_device_wifi_signal_info_properties_changed_ARG_pointers,
    NULL
  },
  "properties-changed"
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_wifi_signal_info_access_point_added_ARG_pointers[] =
{
  &_nmdbus_device_wifi_signal_info_access_point_added_ARG_access_point,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_wifi_signal_info_access_point_removed_ARG_pointers[] =
{
  &_nmdbus_device_wifi_signal_info_access_point_removed_ARG_access_point,
  NULL
};
...
static const _ExtendedGDBusSignalInfo * const _nmdbus_device_wifi_signal_info_pointers[] =
{
  &_nmdbus_device_wifi_signal_info_properties_changed,
  &_nmdbus_device_wifi_signal_info_access_point_added,
  &_nmdbus_device_wifi_signal_info_access_point_removed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _nmdbus_device_wifi_property_info_pointers[] =
{
  &_nmdbus_device_wifi_property_info_hw_address,
  &_nmdbus_device_wifi_property_info_perm_hw_address,
  &_nmdbus_device_wifi_property_info_mode,
  &_nmdbus_device_wifi_property_info_bitrate,
  &_nmdbus_device_wifi_property_info_access_points,
  &_nmdbus_device_wifi_property_info_active_access_point,
  &_nmdbus_device_wifi_property_info_wireless_capabilities,
  NULL
};
 ...
 * @properties_changed: Handler for the #NMDBusDeviceWifi::properties-changed signal.
 *
...
nmdbus_device_wifi_default_init (NMDBusDeviceWifiIface *iface)
{
  ...
  /**
   * NMDBusDeviceWifi::properties-changed:
   * @object: A #NMDBusDeviceWifi.
   * @arg_properties: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-org-freedesktop-NetworkManager-Device-Wireless.PropertiesChanged">"PropertiesChanged"</link> is received.
   *
  ...
  g_signal_new ("properties-changed",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (NMDBusDeviceWifiIface, properties_changed),
    NULL,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_NONE,
 ...
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_wifi_dup_hw_address() if on another thread.</warning>
 *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_wifi_dup_perm_hw_address() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_wifi_dup_access_points() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_wifi_dup_active_access_point() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
...
/**
 * nmdbus_device_wifi_emit_properties_changed:
 * @object: A #NMDBusDeviceWifi.
 * @arg_properties: Argument to pass with the signal.
 *
 * Emits the <link linkend="gdbus-signal-org-freedesktop-NetworkManager-Device-Wireless.PropertiesChanged">"PropertiesChanged"</link> D-Bus signal.
 */
void
nmdbus_device_wifi_emit_properties_changed (
 ...
 * @proxy: A #NMDBusDeviceWifiProxy.
 * @out_access_points: (out): Return location for return parameter or %NULL to ignore.
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _nmdbus_device_wifi_property_info_pointers[prop_id - 1];
...
static void
_nmdbus_device_wifi_on_signal_properties_changed (
    NMDBusDeviceWifi *object,
    GVariant *arg_properties)
{
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      ...
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "org.freedesktop.NetworkManager.Device.Wireless", "PropertiesChanged",
        signal_variant, NULL);
    }
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _nmdbus_device_wifi_schedule_emit_changed (skeleton, _nmdbus_device_wifi_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
...
{
  iface->properties_changed = _nmdbus_device_wifi_on_signal_properties_changed;
