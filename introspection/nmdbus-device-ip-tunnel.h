...
#ifndef __NMDBUS_DEVICE_IP_TUNNEL_H__
#define __NMDBUS_DEVICE_IP_TUNNEL_H__
...
void nmdbus_device_iptunnel_emit_properties_changed (
    NMDBusDeviceIPTunnel *object,
    GVariant *arg_properties);
...
#endif /* __NMDBUS_DEVICE_IP_TUNNEL_H__ */
