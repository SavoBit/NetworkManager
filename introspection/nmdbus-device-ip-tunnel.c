...
static const _ExtendedGDBusArgInfo _nmdbus_device_iptunnel_signal_info_properties_changed_ARG_properties =
{
  {
    -1,
    (gchar *) "properties",
...
static const _ExtendedGDBusArgInfo * const _nmdbus_device_iptunnel_signal_info_properties_changed_ARG_pointers[] =
{
  &_nmdbus_device_iptunnel_signal_info_properties_changed_ARG_properties,
  NULL
};

static const _ExtendedGDBusSignalInfo _nmdbus_device_iptunnel_signal_info_properties_changed =
{
  {
    -1,
    (gchar *) "PropertiesChanged",
    (GDBusArgInfo **) &_nmdbus_device_iptunnel_signal_info_properties_changed_ARG_pointers,
    NULL
  },
  "properties-changed"
};

static const _ExtendedGDBusSignalInfo * const _nmdbus_device_iptunnel_signal_info_pointers[] =
{
  &_nmdbus_device_iptunnel_signal_info_properties_changed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _nmdbus_device_iptunnel_property_info_pointers[] =
{
  &_nmdbus_device_iptunnel_property_info_mode,
  &_nmdbus_device_iptunnel_property_info_parent,
  &_nmdbus_device_iptunnel_property_info_local,
  &_nmdbus_device_iptunnel_property_info_remote,
  &_nmdbus_device_iptunnel_property_info_ttl,
  &_nmdbus_device_iptunnel_property_info_tos,
  &_nmdbus_device_iptunnel_property_info_path_mtu_discovery,
  &_nmdbus_device_iptunnel_property_info_input_key,
  &_nmdbus_device_iptunnel_property_info_output_key,
  &_nmdbus_device_iptunnel_property_info_encapsulation_limit,
  &_nmdbus_device_iptunnel_property_info_flow_label,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusSignalInfo **) &_nmdbus_device_iptunnel_signal_info_pointers,
 ...
 * @properties_changed: Handler for the #NMDBusDeviceIPTunnel::properties-changed signal.
 *
...
nmdbus_device_iptunnel_default_init (NMDBusDeviceIPTunnelIface *iface)
{
  ...
  /**
   * NMDBusDeviceIPTunnel::properties-changed:
   * @object: A #NMDBusDeviceIPTunnel.
   * @arg_properties: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-org-freedesktop-NetworkManager-Device-IPTunnel.PropertiesChanged">"PropertiesChanged"</link> is received.
   *
  ...
  g_signal_new ("properties-changed",
    ...
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (NMDBusDeviceIPTunnelIface, properties_changed),
    NULL,
    NULL,
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_iptunnel_dup_parent() if on another thread.</warning>
 *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_iptunnel_dup_local() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_iptunnel_dup_remote() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_iptunnel_dup_input_key() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_device_iptunnel_dup_output_key() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
...
/**
 * nmdbus_device_iptunnel_emit_properties_changed:
 * @object: A #NMDBusDeviceIPTunnel.
 * @arg_properties: Argument to pass with the signal.
 *
 * Emits the <link linkend="gdbus-signal-org-freedesktop-NetworkManager-Device-IPTunnel.PropertiesChanged">"PropertiesChanged"</link> D-Bus signal.
 */
void
nmdbus_device_iptunnel_emit_properties_changed (
    NMDBusDeviceIPTunnel *object,
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _nmdbus_device_iptunnel_property_info_pointers[prop_id - 1];
...
static void
_nmdbus_device_iptunnel_on_signal_properties_changed (
    NMDBusDeviceIPTunnel *object,
    GVariant *arg_properties)
{
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      ...
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "org.freedesktop.NetworkManager.Device.IPTunnel", "PropertiesChanged",
        signal_variant, NULL);
    }
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _nmdbus_device_iptunnel_schedule_emit_changed (skeleton, _nmdbus_device_iptunnel_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
...
{
  iface->properties_changed = _nmdbus_device_iptunnel_on_signal_properties_changed;
