...
#ifndef __NMDBUS_DEVICE_STATISTICS_H__
#define __NMDBUS_DEVICE_STATISTICS_H__
...
void nmdbus_device_statistics_emit_properties_changed (
    NMDBusDeviceStatistics *object,
    GVariant *arg_properties);
...
#endif /* __NMDBUS_DEVICE_STATISTICS_H__ */
