...
#ifndef __NMDBUS_IP6_CONFIG_H__
#define __NMDBUS_IP6_CONFIG_H__
...
struct _NMDBusIP6ConfigIface
{
  ...
  const gchar *const * (*get_nameservers) (NMDBusIP6Config *object);
...
void nmdbus_ip6_config_emit_properties_changed (
    NMDBusIP6Config *object,
    GVariant *arg_properties);
...
const gchar *const *nmdbus_ip6_config_get_nameservers (NMDBusIP6Config *object);
gchar **nmdbus_ip6_config_dup_nameservers (NMDBusIP6Config *object);
void nmdbus_ip6_config_set_nameservers (NMDBusIP6Config *object, const gchar *const *value);
