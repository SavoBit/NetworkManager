...
static const _ExtendedGDBusArgInfo _nmdbus_ip6_config_signal_info_properties_changed_ARG_properties =
{
  {
    -1,
    (gchar *) "properties",
...
static const _ExtendedGDBusArgInfo * const _nmdbus_ip6_config_signal_info_properties_changed_ARG_pointers[] =
{
  &_nmdbus_ip6_config_signal_info_properties_changed_ARG_properties,
  NULL
};

static const _ExtendedGDBusSignalInfo _nmdbus_ip6_config_signal_info_properties_changed =
{
  {
    -1,
    (gchar *) "PropertiesChanged",
    (GDBusArgInfo **) &_nmdbus_ip6_config_signal_info_properties_changed_ARG_pointers,
    NULL
  },
  "properties-changed"
};

static const _ExtendedGDBusSignalInfo * const _nmdbus_ip6_config_signal_info_pointers[] =
{
  &_nmdbus_ip6_config_signal_info_properties_changed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _nmdbus_ip6_config_property_info_pointers[] =
{
  &_nmdbus_ip6_config_property_info_addresses,
  &_nmdbus_ip6_config_property_info_address_data,
  &_nmdbus_ip6_config_property_info_gateway,
  &_nmdbus_ip6_config_property_info_routes,
  &_nmdbus_ip6_config_property_info_route_data,
  &_nmdbus_ip6_config_property_info_nameservers,
  &_nmdbus_ip6_config_property_info_domains,
  &_nmdbus_ip6_config_property_info_searches,
  NULL
};
...
{
  {
    ...
    NULL,
    (GDBusSignalInfo **) &_nmdbus_ip6_config_signal_info_pointers,
 ...
 * @properties_changed: Handler for the #NMDBusIP6Config::properties-changed signal.
 *
...
nmdbus_ip6_config_default_init (NMDBusIP6ConfigIface *iface)
{
  ...
  /**
   * NMDBusIP6Config::properties-changed:
   * @object: A #NMDBusIP6Config.
   * @arg_properties: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-org-freedesktop-NetworkManager-IP6Config.PropertiesChanged">"PropertiesChanged"</link> is received.
   *
  ...
  g_signal_new ("properties-changed",
    ...
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (NMDBusIP6ConfigIface, properties_changed),
    NULL,
    NULL,
   ...
   */
  g_object_interface_install_property (iface,
    g_param_spec_boxed ("nameservers", "Nameservers", "Nameservers", G_TYPE_STRV, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
  /**
 ...
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_addresses() if on another thread.</warning>
 *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_address_data() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
GVariant *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_gateway() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_routes() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
GVariant *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_route_data() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
GVariant *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_nameservers() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 */
void
nmdbus_ip6_config_set_nameservers (NMDBusIP6Config *object, const gchar *const *value)
{
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_domains() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use nmdbus_ip6_config_dup_searches() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
...
/**
 * nmdbus_ip6_config_emit_properties_changed:
 * @object: A #NMDBusIP6Config.
 * @arg_properties: Argument to pass with the signal.
 *
 * Emits the <link linkend="gdbus-signal-org-freedesktop-NetworkManager-IP6Config.PropertiesChanged">"PropertiesChanged"</link> D-Bus signal.
 */
void
nmdbus_ip6_config_emit_properties_changed (
    NMDBusIP6Config *object,
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _nmdbus_ip6_config_property_info_pointers[prop_id - 1];
...
nmdbus_ip6_config_proxy_get_nameservers (NMDBusIP6Config *object)
{
  ...
  value = g_datalist_get_data (&proxy->priv->qdata, "Nameservers");
  if (value != NULL)
    return value;
  ...
  if (variant != NULL)
    {
      ...
      g_datalist_set_data_full (&proxy->priv->qdata, "Nameservers", (gpointer) value, g_free);
      g_variant_unref (variant);
    }
  return value;
}
...
static void
_nmdbus_ip6_config_on_signal_properties_changed (
    NMDBusIP6Config *object,
    GVariant *arg_properties)
{
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      ...
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "org.freedesktop.NetworkManager.IP6Config", "PropertiesChanged",
        signal_variant, NULL);
    }
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _nmdbus_ip6_config_schedule_emit_changed (skeleton, _nmdbus_ip6_config_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
...
{
  iface->properties_changed = _nmdbus_ip6_config_on_signal_properties_changed;
